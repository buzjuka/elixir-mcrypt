defmodule McryptTest do
  ...
  @block_ciphertext <<155, 241, 126, 100, 201, 99, 156, 200, 237, 54, 23, 212, 153, 244, 204, 38, 115, 228, 46, 139, 181, 40, 210, 197, 0, 102, 54, 48, 52, 135, 3, 251>>
  ...
  test "block_encrypting matches a known ciphertext" do
    assert Mcrypt.block_encrypt(@plaintext, :rijndael_256, :nofb, @key, @iv) == {:ok, @block_ciphertext}
  end

  test "block_decrypting a known ciphertext reproduces the plaintext" do
    assert Mcrypt.block_decrypt(@block_ciphertext, :rijndael_256, :nofb, @key, @iv) == {:ok, @plaintext}
  end
end
